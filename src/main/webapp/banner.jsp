...
<div id="wrapper">
    ...
    float: left;">
				<a class="navbar-brand" href="admin" style="margin-top: 3px; color: white;">Phường Thanh Bình - Hải
					Châu</a>
			</div>
...
<aside class="sidebar navbar-default" role="navigation" style="    margin-top: 82px;">
