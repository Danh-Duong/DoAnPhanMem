                    ...
                    <div class="row">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<input class="info-value" name="soCCCD">
							</div>
							<div class="col-md-4">
                    ...
                    <div class="row">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<input type="date" class="info-value" name="ngayBatDauVang">
							</div>
							<div class="col-md-4">
								<p class="info-title1">Đến ngày:</p>
								<input type="date" class="info-value" name="ngayKetThucVang">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
