    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <div style="display: flex; align-items: center; margin-top: 14px;">
                ...
                <select id="trangthai" class="form-select" name="trangthai" onchange="changeTrangthai(this)"
                    ...
                    <option value="-1" ${trangthai=="-1" ? "selected" : ""}>Đã hủy</option>
                </select>
            </div>
            <c:forEach items="${hoso}" var="hs" varStatus="loop">
                <c:if test="${trangthai=='1'}">
                    <div class="alert alert-info" style="margin-top: 20px;">
                        ${loop.index+1}. Mã hồ sơ: ${hs.maTamTru} - Mã nhân khẩu: ${hs.idNhanKhau} 
                        <a style="float: right;" href="duyetTamTru?mahs=${hs.maTamTru}" class="alert-link"> Chi tiết</a>
